import use_cases.moral_envs.randomized_v3 as randomized_v3
import use_cases.moral_envs.randomized_v2 as randomized_v2
...
class GymWrapper(gym.Env):
    ...
    def reset(self):
        if self.env_id == 'randomized_v2':
            self.game = randomized_v2.make_game()
        elif self.env_id == 'randomized_v3':
            self.game = randomized_v3.make_game()
    ...
    def step(self, action):
        ...
        return self._obs_to_np_array(obs), reward, game_over or self.game.game_over, self.game.the_plot
